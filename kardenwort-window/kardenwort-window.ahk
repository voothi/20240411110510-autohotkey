...
InjectHoverHighlightMvp(guiObj, bookmarksN) {
    try {
        ...
        css .= "  background-color: transparent !important;"
        css .= "}"
        css .= "body.rmb-active span.word:hover {"
        css .= "  word-break: break-all !important;"
        css .= "}"
        ...
        js .= "  var rmbX = 0, rmbY = 0;"
        js .= "  addEvent(document, 'mousedown', function(e) {"
        js .= "    var btn = (e.button !== undefined) ? e.button : e.which;"
        js .= "    if (btn === 2) {"
        js .= "      addClass(document.body, 'rmb-active');"
        js .= "      rmbX = e.clientX; rmbY = e.clientY;"
        js .= "    }"
        js .= "  });"
        js .= "  addEvent(document, 'mousemove', function(e) {"
        js .= "    if (document.body.classList && document.body.classList.contains('rmb-active')) {"
        js .= "      var dx = Math.abs(e.clientX - rmbX);"
        js .= "      var dy = Math.abs(e.clientY - rmbY);"
        js .= "      if (dx > 10 || dy > 10) {"
        js .= "        removeClass(document.body, 'rmb-active');"
        js .= "      }"
        js .= "    }"
        js .= "  });"
