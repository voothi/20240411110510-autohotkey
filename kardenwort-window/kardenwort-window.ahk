...
InjectHoverHighlightMvp(guiObj, bookmarksN) {
    try {
        ...
        js .= "        var targetSpan = isSource ? transSpansArray[idx] : sourceSpansArray[idx];"
        js .= "        if (targetSpan) {"
        ...
        js .= "          if (bookmarks[b].idx === idxStr) { isPinned = true; break; }"
        js .= "        }"
        js .= "        if (targetSpan && !isPinned) {"
        ...
        js .= "        if (bookmarks[i].idx === idxStr) { bIdx = i; break; }"
        js .= "      }"
        js .= "      var idx = parseInt(idxStr, 10);"
        js .= "      var srcSpan = sourceSpansArray[idx];"
        js .= "      var transSpan = transSpansArray[idx];"
        js .= "      if (bIdx !== -1) {"
        js .= "        if (srcSpan) removeClass(srcSpan, 'hl-mvp-pin');"
        js .= "        if (transSpan) removeClass(transSpan, 'hl-mvp-pin');"
