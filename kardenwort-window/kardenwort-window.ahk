...
InjectHoverHighlightMvp(guiObj, bookmarksN) {
    try {
        ...
        js .= "          if (oldest.srcSpan) { removeClass(oldest.srcSpan, 'hl-mvp-pin'); removeClass(oldest.srcSpan, 'hl-mvp-hover'); }"
        js .= "          if (oldest.transSpan) { removeClass(oldest.transSpan, 'hl-mvp-pin'); removeClass(oldest.transSpan, 'hl-mvp-hover'); }"
        js .= "        }"
        js .= "      }"
        js .= "    };"
