...
InjectHoverHighlightMvp(guiObj, bookmarksN) {
    try {
        ...
        js .= "    if (el.classList) el.classList.add(name);"
        js .= "  }"
        js .= "  function removeClass(el, name) {"
        js .= "    if (el.classList) el.classList.remove(name);"
        js .= "  }"
        ...
        js .= "        try {"
        js .= "          if (entry.srcSpan && document.body.contains(entry.srcSpan)) {"
        js .= "            removeClass(entry.srcSpan, 'hl-mvp-pin');"
        js .= "            removeClass(entry.srcSpan, 'hl-mvp-hover');"
        js .= "          }"
        js .= "        } catch(e) {}"
        js .= "        try {"
        js .= "          if (entry.transSpan && document.body.contains(entry.transSpan)) {"
