...
; Load Settings
CurrentSalt := IniRead(ConfigName, "Security", "Salt", "")
CurrentSecretsPath := IniRead(ConfigName, "Security", "SecretsPath", "")
...
if (CurrentSalt == "") {
    ...
    IniWrite(CurrentSalt, ConfigName, "Security", "Salt")
}
...
if (CurrentSecretsPath == "") {
    ...
    IniWrite(CurrentSecretsPath, ConfigName, "Security", "SecretsPath")
}
